...
namespace AssetCheckoutSystem.Migrations
{
    ...
    [Migration("20260706213521_AssetHistorySeedData")]
    partial class AssetHistorySeedData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AssetCheckoutSystem.Models.Entities.AssetHistory", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 2, 9, 0, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            AssetId = new Guid("a1111111-0000-0000-0000-000000000001"),
                            CreatedAt = new DateTime(2025, 1, 10, 10, 0, 1, 0, DateTimeKind.Utc),
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 3, 9, 0, 0, 0, DateTimeKind.Utc),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            ...
                            Action = "Updated Asset Status",
                            AssetId = new Guid("a1111111-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2025, 1, 3, 9, 1, 0, 0, DateTimeKind.Utc),
                        ...
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 4, 9, 0, 0, 0, DateTimeKind.Utc),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            ...
                            Action = "Updated Asset Status",
                            AssetId = new Guid("a2222222-0000-0000-0000-000000000001"),
                            CreatedAt = new DateTime(2025, 1, 4, 9, 1, 0, 0, DateTimeKind.Utc),
                            NewValue = "Assigned",
                            OldValue = "Available",
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            ...
                            AssetId = new Guid("a2222222-0000-0000-0000-000000000001"),
                            CreatedAt = new DateTime(2025, 1, 4, 9, 1, 1, 0, DateTimeKind.Utc),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Action = "Updated Asset Status",
                            AssetId = new Guid("a2222222-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2025, 1, 4, 9, 2, 0, 0, DateTimeKind.Utc),
                            NewValue = "Assigned",
                            OldValue = "Available",
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            ...
                            Action = "Assigned Asset to employee@test.com",
                            AssetId = new Guid("a2222222-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2025, 1, 4, 9, 2, 1, 0, DateTimeKind.Utc),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2025, 1, 5, 9, 0, 0, 0, DateTimeKind.Utc),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            ...
                            Action = "Updated Asset Status",
                            AssetId = new Guid("a2222222-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2025, 1, 5, 9, 1, 0, 0, DateTimeKind.Utc),
                            NewValue = "Retired",
                            OldValue = "Available",
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                            ...
                            AssetId = new Guid("a2222222-0000-0000-0000-000000000003"),
                            CreatedAt = new DateTime(2025, 1, 5, 9, 1, 1, 0, DateTimeKind.Utc),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            Action = "Assigned Asset to employee@test.com",
                            AssetId = new Guid("a3333333-0000-0000-0000-000000000001"),
                            CreatedAt = new DateTime(2025, 1, 15, 10, 0, 1, 0, DateTimeKind.Utc),
                            UserId = new Guid("11111111-1111-1111-1111-111111111111")
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            AssetId = new Guid("a3333333-0000-0000-0000-000000000001"),
                            CreatedAt = new DateTime(2025, 1, 20, 10, 0, 1, 0, DateTimeKind.Utc),
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Action = "Updated Asset Status",
                            AssetId = new Guid("a3333333-0000-0000-0000-000000000001"),
                            CreatedAt = new DateTime(2025, 1, 20, 10, 0, 2, 0, DateTimeKind.Utc),
                            NewValue = "Available",
                            OldValue = "Assigned",
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        ...
                        new
                        {
                            ...
                            Action = "Updated Asset Status",
                            AssetId = new Guid("a4444444-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2025, 1, 7, 9, 1, 0, 0, DateTimeKind.Utc),
                            NewValue = "Assigned",
                            OldValue = "Available",
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        },
                        new
                        {
                            ...
                            Action = "Assigned Asset to employee@test.com",
                            AssetId = new Guid("a4444444-0000-0000-0000-000000000002"),
                            CreatedAt = new DateTime(2025, 1, 7, 9, 1, 1, 0, DateTimeKind.Utc),
                            UserId = new Guid("22222222-2222-2222-2222-222222222222")
                        });
                });
